...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MainAppPage(title: 'Grouped Scroll View Demo'),
    );
  }
}
...
class MainAppPage extends StatefulWidget {
  ...
  @override
  State<MainAppPage> createState() => _MainAppState();
}

class _MainAppState extends State<MainAppPage> {
  int _curIdx = 0;
  final List<Widget> _widgets = [
    const GroupedGridViewTestPage(crossAxisCount: 3),
    const GroupedListViewTestPage()
  ];
  final List<String> _titles = ['GroupedGrid', 'GroupedList'];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(_titles[_curIdx]),
      ),
      body: Center(
        // Center is a layout widget. It takes a single child and positions it
        // in the middle of the parent.
        child: _widgets.elementAt(_curIdx),
      ),
